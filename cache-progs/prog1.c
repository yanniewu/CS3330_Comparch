...
int main() {
    const int MAX = 8192; // want to make this the size of the larger cache value
    const int SKIP = 16; // this should be the sizze of the cache block (same value is shared)
