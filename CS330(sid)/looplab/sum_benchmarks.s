...
.LC3:
	...
	.align 8
.LC4:
	.string	"sum_unrolled2: unrolled two iterations"
	.align 8
.LC5:
	.string	"sum_unrolled2: unrolled four iterations"
	.align 8
.LC6:
	.string	"sum_multiple_accum: unrolled 4 iterations and use 2 accumulators"
	.align 8
.LC7:
	.string	"sum_multiple_accum_C: simple C with 4 iterations unrolled and 2 accumulators"
	.data
	.align 32
